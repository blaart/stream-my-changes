// there is a bug in zongji, see https://github.com/nevill/zongji/issues/101
// so for now copy this file as fix:
...
ZongJi.prototype._fetchTableInfo = function(tableMapEvent, next) {
  ...
  this.ctrlConnection.query(sql, function(err, rows) {
    ...
    console.dir ('tableMapEvent:' + util.inspect(tableMapEvent));
